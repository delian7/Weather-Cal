...
const weatherCal = {
  ...
  initialize(name, iCloudInUse) {
    ...
    this.widgetUrl = "https://raw.githubusercontent.com/delian7/Weather-Cal/main/weather-cal.js"
    this.now = new Date()
    this.data = {}
...
if (moduleName == Script.name()) {
  await (async () => {
    ...
    await weatherCal.runSetup(name, true, "Weather Cal code", "https://raw.githubusercontent.com/delian7/Weather-Cal/main/weather-cal-code.js")
